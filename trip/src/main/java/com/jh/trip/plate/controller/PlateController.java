...
public class PlateController {
	...
	public ModelAndView searchResult(@RequestParam("mainTema") String mainTema, @RequestParam("subTema") String subTema,
			@RequestParam("addressDo") String addressDo, @RequestParam("addressDogun") String addressDogun, ModelAndView mv) {
		
		System.out.println(mainTema +","+ subTema +","+ addressDo +","+ addressDogun);
		...
		Plate p = Plate.builder().areacode(Integer.toString(areacode)).sigungucode(Integer.toString(sigungucode))
