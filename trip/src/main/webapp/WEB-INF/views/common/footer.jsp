...
<c:set var="path" value="${pageContext.request.contextPath}"/>
 ...
 <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>Traveler</h3>
            <p>여행 플래너 웹사이트. 테마부터 교통 수단까지, 고객 맞춤형 여행 계획을 제공하는 사이트입니다. ‘이색적인 여행을 꿈꾸는 사람을 위한 프로젝트 여행! 전문가와 소통하며, 나를 위한 취향 저격 여행 코스 설계를 기대하세요!’</p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              FIGHTING<br>
              YEAH<br>
              <strong>Phone:</strong>00700<br>
              <strong>Email:</strong> allin@allin.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        <!-- &copy; Copyright <strong><span>ALLIN</span></strong>. All Rights Reserved -->
        © Copyright Serenity. All Rights Reserved,
